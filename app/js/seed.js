  ...
  const interventions = [
    {
      ...
      statusHistory: [
        ...
        { status: 'assigned', changedBy: 'Admin User',        timestamp: d(-2), note: 'Assigned to Jean-Marc Dupont' },
        { status: 'ongoing',  changedBy: 'Jean-Marc Dupont',  timestamp: d(-1), note: 'Technician on site' }
      ],
      auditTrail: [
    ...
    },
    {
      ...
      statusHistory: [
        ...
        { status: 'planned', changedBy: 'Admin User', timestamp: d(-4), note: 'Scheduled and assigned to Priya Naidoo' }
      ],
      auditTrail: [
    ...
    },
    {
      ...
      statusHistory: [
        ...
        { status: 'assigned',      changedBy: 'Admin User',       timestamp: d(-9),  note: 'Assigned to Jean-Marc Dupont' },
        { status: 'ongoing',       changedBy: 'Jean-Marc Dupont', timestamp: d(-7),  note: 'Technician on site, pump seized' },
        { status: 'waiting_parts', changedBy: 'Jean-Marc Dupont', timestamp: d(-2),  note: 'Part ordered from Germany' }
      ],
      auditTrail: [
    ...
    },
    {
      ...
      statusHistory: [
        ...
        { status: 'assigned',  changedBy: 'Admin User',   timestamp: d(-15), note: 'Assigned to Priya Naidoo' },
        { status: 'ongoing',   changedBy: 'Priya Naidoo', timestamp: d(-14), note: 'Technician on site' },
        { status: 'completed', changedBy: 'Priya Naidoo', timestamp: d(-13), note: 'PM completed successfully' }
      ],
      auditTrail: [
    ...
    },
    {
      ...
      statusHistory: [
        ...
        { status: 'assigned', changedBy: 'Admin User', timestamp: d(-1), note: 'Assigned to Priya Naidoo' }
      ],
      auditTrail: [
    ...
    },
    {
      ...
      statusHistory: [
        ...
        { status: 'pending', changedBy: 'Jean-Marc Dupont', timestamp: d(-1), note: 'Awaiting site access confirmation' }
      ],
      auditTrail: [
    ...
    },
    {
      ...
      statusHistory: [
        ...
        { status: 'completed', changedBy: 'Priya Naidoo', timestamp: d(-29), note: 'Inspection complete, all OK' }
      ],
      auditTrail: [
    ...
    },
    {
      ...
      statusHistory: [
        ...
        { status: 'planned', changedBy: 'Admin User', timestamp: d(-6), note: 'Scheduled and assigned to Jean-Marc Dupont' }
      ],
      auditTrail: [
    ...
    },
    {
      ...
      statusHistory: [
        ...
        { status: 'ongoing',   changedBy: 'Jean-Marc Dupont', timestamp: d(-45), note: 'PM started' },
        { status: 'completed', changedBy: 'Jean-Marc Dupont', timestamp: d(-44), note: 'All parameters within spec' }
      ],
      auditTrail: [
    ...
    },
    {
      ...
      statusHistory: [
        ...
        { status: 'assigned',  changedBy: 'Admin User',   timestamp: d(-21), note: 'Assigned to Priya Naidoo' },
        { status: 'ongoing',   changedBy: 'Priya Naidoo', timestamp: d(-20), note: 'Technician on site, inspection started' },
        { status: 'cancelled', changedBy: 'Priya Naidoo', timestamp: d(-19), note: 'No fault found, false alarm' }
      ],
      auditTrail: [
    ...
    },
    {
      ...
      statusHistory: [
        ...
        { status: 'assigned', changedBy: 'Admin User', timestamp: d(-1), note: 'Assigned to Jean-Marc Dupont' }
      ],
      auditTrail: [
    ...
    },
    {
      ...
      parts: [], createdBy: 'Admin User',
      statusHistory: [
        { status: 'assigned', changedBy: 'Admin User',   timestamp: d(-1), note: 'Intervention created, assigned to Priya Naidoo' },
        { status: 'ongoing',  changedBy: 'Priya Naidoo', timestamp: d(0),  note: 'Remote session started' }
      ],
      auditTrail: [
