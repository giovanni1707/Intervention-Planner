...
const Sidebar = {
  ...
  _navItems: [
    ...
    {
      route: 'users', label: 'Users', adminOnly: false, superAdminOnly: true,
      icon: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M17 21v-2a4 4 0 00-4-4H5a4 4 0 00-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 00-3-3.87"/><path d="M16 3.13a4 4 0 010 7.75"/></svg>`
    },
    {
      route: 'action-log', label: 'Action Log', adminOnly: false, superAdminOnly: true,
    ...
    {
      route: 'deleted-jobs', label: 'Deleted Jobs', adminOnly: true, superAdminOnly: false,
