...
Views.JobTracker = {
  ...
  _deleteJob(interventionId) {
    ...
    `, `
      ...
      <button class="btn btn-danger" onclick="Views.JobTracker._confirmDeleteJob('${interventionId}','${jobNumber}')">Delete Job</button>
    `);
  },

  async _confirmDeleteJob(interventionId, expectedJobNumber) {
